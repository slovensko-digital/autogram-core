...
public class XMLUtilsTest {
    ...
    public void testGetSecureTransformerFactoryBlocksExternalStylesheet() throws Exception {
        ...
        try {
            ...
            assertEquals("net.sf.saxon.s9api.SaxonApiException: URIs using protocol file are not permitted", e.getMessage());
        }
    }
    ...
    public void testGetSecureTransformerFactoryBlocksExternalDTD() throws Exception {
        ...
        try {
            ...
            assertEquals("net.sf.saxon.s9api.SaxonApiException: I/O error reported by XML parser processing null", e.getMessage());
        }
    }
    ...
    public void testGetSecureSchemaFactoryBlocksExternalSchema() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("accessExternalSchema"));
        }
    }
    ...
    public void testGetSecureSchemaFactoryBlocksExternalDTD() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("Failed to read external DTD") || e.getMessage().contains("DOCTYPE is disallowed"));
        }
    }
